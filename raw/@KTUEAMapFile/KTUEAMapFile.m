...
%%
    ...
    methods
        ...
        function setAxisBackgroundColor(dummy, curColor)
%         function setAxisBackgroundColor(~, curColor)
        ...
        function setXAxisColor(dummy, curColor)
%         function setXAxisColor(~, curColor)
        ...
        function setYAxisColor(dummy, curColor)
%         function setYAxisColor(~, curColor)    
          ...
          function setAxesColor(dummy, curColor)
