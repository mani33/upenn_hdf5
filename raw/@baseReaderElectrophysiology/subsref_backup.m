...
%   't' for the timestamps in milliseconds. If you need to get samples for
%   given timestamp range, use 't_int' as the second argument and use a two
%   element vector [tStart tEnd] as the first argument. tStart and tEnd
%   should be in 
%
% AE 2011-04-11
